...
open class WaveView : View {
    ...
    private fun init(attrs: AttributeSet) {
        ...
        mAmplitudeRatio =
            typedArray.getFloat(R.styleable.WaveView_amplitudeRatio, DEFAULT_AMPLITUDE_RATIO)
        mWaterLevelRatio =
            typedArray.getFloat(R.styleable.WaveView_waveWaterLevel, DEFAULT_WATER_LEVEL_RATIO)
        waveLengthRatio =
            typedArray.getFloat(R.styleable.WaveView_waveLengthRatio, DEFAULT_WAVE_LENGTH_RATIO)
        mWaveShiftRatio =
            typedArray.getFloat(R.styleable.WaveView_waveShiftRatio, DEFAULT_WAVE_SHIFT_RATIO)
        mFrontWaveColor =
            typedArray.getColor(R.styleable.WaveView_frontWaveColor, DEFAULT_FRONT_WAVE_COLOR)
        mBehindWaveColor =
            typedArray.getColor(R.styleable.WaveView_behindWaveColor, DEFAULT_BEHIND_WAVE_COLOR)
        mShapeType = if (typedArray.getInt(
                R.styleable.WaveView_waveViewShape,
                0
            ) == 0
    ...
    companion object {
        ...
        val DEFAULT_BEHIND_WAVE_COLOR: Int = Color.parseColor("#28FFFFFF")
        val DEFAULT_FRONT_WAVE_COLOR: Int = Color.parseColor("#3CFFFFFF")
